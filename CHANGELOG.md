...
- Fixed top row of player preview being faded, causing it to appear weirdly cut off
...
- Fixed Poly+ crash reporting replacing the real cause of a crash with its own error in some cases
